...
export const backetSlice = createSlice({
  ...
  reducers: {
    ...
    removeFromTheBucket: (state: any, action) => {
...
export const { addToBacket, removeFromTheBucket } = backetSlice.actions;
export const backetReduser = backetSlice.reducer;
